...
setup(
    name='pandas_datareaders_unofficial',
    ...
    url='https://github.com/femtotrader/pandas_datareaders_unofficial',
    ...
    install_requires=['pandas', 'requests', 'requests-cache', 'six', 'html5lib'],
